...
class CNN extends React.Component {
  ...
  onChange = (event) => {
    this.setState({
      ...
      filtered: this.getArticleByStation("Cable News Network").filter((article) => {
  ...
  render() {
    const data = {
        labels: ["All Time CNN News Sentiment (from #AboutAWeekAgo)"],
        datasets: [
            {
                label: "Anger",
                backgroundColor: '#FF4136',
                borderWidth: 1,
                data: [this.getEmotionByStation("anger", "Cable News Network")],
            },
            {
                label: "Joy",
                backgroundColor: '#A1E9F4',
                borderWidth: 1,
                data: [this.getEmotionByStation("joy", "Cable News Network")],
            },
            {
                label: "Fear",
                backgroundColor: '#480710',
                borderWidth: 1,
                data: [this.getEmotionByStation("fear", "Cable News Network")],
            },
            {
                label: "Surprise",
                backgroundColor: '#01FF70',
                borderWidth: 1,
                data: [this.getEmotionByStation("surprise", "Cable News Network")],
            },
            {
                label: "Sadness",
